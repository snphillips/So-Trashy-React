...
export default function Sidebar({ refuseTypeSubmit, sortOrderRadioSubmit, year, yearDropdownSubmit }: Props) {
  return (
    <aside className="sidebar">
      <div className="sidebar-content">
        ...
        <p className="sidebar-text">
          Visualizing a neighborhood comparison of trash, recycling, and compost pick-up in New York City.
        </p>
        ...
        <p className="sidebar-text sidebar-link">
          ...
          >
            DSNY Monthly Tonnage Data <i className="fa fa-external-link-square" aria-hidden="true"></i>
          </a>
        </p>
        <p className="sidebar-text sidebar-link">
          <a
          ...
          >
            NYC Population by District <i className="fa fa-external-link-square" aria-hidden="true"></i>
          </a>
        </p>
        <p className="sidebar-text sidebar-link">
          <a href="https://communityprofiles.planning.nyc.gov/" id="community-district-link">
            Find your community district here <i className="fa fa-external-link-square" aria-hidden="true"></i>
          </a>
        </p>
        <Footer />
      </div>
