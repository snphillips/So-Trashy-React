  ...
  return (
    <form className="radio-toolbar" id="radio-toolbar-type" onChange={refuseTypeSubmit}>
      <fieldset>
        ...
        <input type="radio" className="radio-type" name="radioType" id="refusetonscollected" value="trash" />
        <label htmlFor="refusetonscollected">🗑️ trash</label>
        <br />

        <input type="radio" className="radio-type" name="radioType" id="papertonscollected" value="paper & cardboard" />
        <label htmlFor="papertonscollected">🗞️📦 paper & cardboard</label>
        <br />

        <input type="radio" className="radio-type" name="radioType" id="mgptonscollected" value="metal/glass/plastic" />
        <label htmlFor="mgptonscollected">🥫🍾🧃 metal/glass/plastic</label>
        <br />

        <input type="radio" className="radio-type" name="radioType" id="resorganicstons" value="brown bin organics" />
        <label htmlFor="resorganicstons">🥬🥕🍎 brown bin organics</label>
        <br />

        <input type="radio" className="radio-type" name="radioType" id="leavesorganictons" value="leaves" />
        <label htmlFor="leavesorganictons">🍂 leaves</label>
        <br />

        <input type="radio" className="radio-type" name="radioType" id="xmastreetons" value="christmas trees" />
